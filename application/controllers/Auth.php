	...
	public function register() {
			...
			if (isset($_POST['register'])) {
				...
				if ($this->form_validation->run() == TRUE) {
					...
					// migrate to model $this->db->insert('users',$data);
